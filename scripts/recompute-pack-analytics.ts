...
/**
 * Recompute analytics for pack files
 * Updates analytics fields in pack.json files to match current prompts
 */
...
function findPackFiles(workspaceId: string): PackFile[] {
...
function updatePackAnalytics(packFile: PackFile): boolean {
  try {
